  ...
  ask turtles with [energy > reproduce-energy] [
    ...
    hatch 1 [
      ...
      if random-float 1 < mutate-turtles [
        set hsb-color new-hsb (hsb-color)
        set color (hsb hsb-color 255 255) ]
    ]
  ]
end
