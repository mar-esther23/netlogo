...
to go  ;; forever button
  ...
  ask turtles with [pcolor != orange and chemical >= threshold ] [ flock ]
  ask turtles [
...
to uphill-chemical  ;; turtle procedure
  ...
  [ ifelse scent-right > scent-left
    ...
    [ lt 45 ] ]
  ;;
  ;;let nestx pxcor let nesty pycor let chem 0
  ;;ask neighbors [ if nest-scent > chem [set nestx pxcor set nesty pycor]]
  ;;if chemical > flock [let heading-me heading
  ;;  ask turtles in-radius 1 with [color != orange] [set heading heading-me]]
end
...
to flock  ;; turtle procedure
  set flockmates other turtles in-radius 3 with [color != orange]
  if any? flockmates
...
To refer to this model in academic publications, please use:  Wilensky, U. (1997).  NetLogo Ants model.  http://ccl.northwestern.edu/netlogo/models/Ants.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.

In other publications, please use:  Copyright 1997 Uri Wilensky.  All rights reserved.  See http://ccl.northwestern.edu/netlogo/models/Ants for terms of use.
@#$#@#$#@
default
true
0
